...
using vannsmobileService.Models.Map;

namespace vannsmobileService.Models
{
    public class vannsmobileContext : DbContext
    {
        ...
        public vannsmobileContext() : base(connectionStringName)
        {
        }
